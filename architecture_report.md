...
On six positive known-answer queries over this 67-document set, retrieval found the expected document at rank 1 for all six queries. These included health specialties, sports entities, urban planning, postal services, judicial enforcement for Ministry of Commerce officers, and the A'Sharqiya University branch decision. This is a useful sanity check, not a complete benchmark: the queries are hand-labeled, small in number, and partly based on recently crawled documents.
